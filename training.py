...
def save_parameters(price_min, price_max, thtea0, theta1):
...
def linear_regression(x, y, n, learning_speed):
	...
	# Loop until convergence or 100000 epochs
	for _ in range(100000):
		...
		if abs(new_mse - mse) < 0.0000000001:
			break
...
# Save the parameters
save_parameters(price.min(), price.max(), theta0, theta1)
